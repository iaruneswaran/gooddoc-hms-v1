...
const diagnosticsOrders: DiagnosticsOrder[] = [
  ...
  { id: "R011", patientId: "P110", patientName: "Amit Gupta", gdid: "110", ageSex: "45 | M", visitId: "V25-410", location: "OP", tests: "MRI Brain", type: "Radiology", modality: "MRI", status: "Ordered", scheduledAt: new Date("2025-12-18T10:30:00"), imagingLocation: "RAD-3", contrast: false, criticalResult: false },
  ...
  { id: "R012", patientId: "P111", patientName: "Priya Gupta", gdid: "111", ageSex: "38 | F", visitId: "V25-411", location: "OP", tests: "US Abdomen", type: "Radiology", modality: "US", status: "Scheduled", scheduledAt: new Date("2025-12-18T10:45:00"), imagingLocation: "RAD-4", contrast: false, criticalResult: false },
  ...
  { id: "R013", patientId: "P112", patientName: "Rahul Gupta", gdid: "112", ageSex: "52 | M", visitId: "V25-412", location: "Ward-A", bed: "Bed 3", tests: "CT Chest", type: "Radiology", modality: "CT", status: "In-Progress", scheduledAt: new Date("2025-12-18T11:00:00"), imagingLocation: "RAD-1", contrast: true, criticalResult: false },
  ...
  { id: "R015", patientId: "P114", patientName: "Vikram Gupta", gdid: "114", ageSex: "44 | M", visitId: "V25-414", location: "OP", tests: "X-ray Knee", type: "Radiology", modality: "X-ray", status: "Finalized", scheduledAt: new Date("2025-12-18T11:30:00"), imagingLocation: "RAD-3", contrast: false, criticalResult: false },
  ...
  { id: "R016", patientId: "P115", patientName: "Anjali Sharma", gdid: "115", ageSex: "55 | F", visitId: "V25-415", location: "Ward-A", bed: "Bed 6", tests: "CT Head", type: "Radiology", modality: "CT", status: "Ordered", scheduledAt: new Date("2025-12-18T11:45:00"), imagingLocation: "RAD-4", contrast: false, criticalResult: false },
  ...
  { id: "R017", patientId: "P116", patientName: "Karthik Sharma", gdid: "116", ageSex: "61 | M", visitId: "V25-416", location: "OP", tests: "Chest X-ray", type: "Radiology", modality: "X-ray", status: "Scheduled", scheduledAt: new Date("2025-12-18T12:00:00"), imagingLocation: "RAD-1", contrast: true, criticalResult: false },
  ...
  { id: "R018", patientId: "P117", patientName: "Divya Sharma", gdid: "117", ageSex: "33 | F", visitId: "V25-417", location: "OP", tests: "CT Abdomen", type: "Radiology", modality: "CT", status: "In-Progress", scheduledAt: new Date("2025-12-18T12:15:00"), imagingLocation: "RAD-2", contrast: false, criticalResult: false },
  ...
  { id: "R020", patientId: "P119", patientName: "Lakshmi Sharma", gdid: "119", ageSex: "48 | F", visitId: "V25-419", location: "OP", tests: "US Abdomen", type: "Radiology", modality: "US", status: "Finalized", scheduledAt: new Date("2025-12-18T12:45:00"), imagingLocation: "RAD-4", contrast: false, criticalResult: false },
  ...
  { id: "R021", patientId: "P120", patientName: "Rajan Sharma", gdid: "120", ageSex: "58 | M", visitId: "V25-420", location: "OP", tests: "CT Chest", type: "Radiology", modality: "CT", status: "Ordered", scheduledAt: new Date("2025-12-18T13:00:00"), imagingLocation: "RAD-1", contrast: true, criticalResult: true },
  ...
  { id: "R022", patientId: "P121", patientName: "Meena Sharma", gdid: "121", ageSex: "39 | F", visitId: "V25-421", location: "Ward-A", bed: "Bed 2", tests: "MRI Spine", type: "Radiology", modality: "MRI", status: "Scheduled", scheduledAt: new Date("2025-12-18T13:15:00"), imagingLocation: "RAD-2", contrast: false, criticalResult: false },
  ...
  { id: "R023", patientId: "P122", patientName: "Arjun Sharma", gdid: "122", ageSex: "66 | M", visitId: "V25-422", location: "OP", tests: "X-ray Knee", type: "Radiology", modality: "X-ray", status: "In-Progress", scheduledAt: new Date("2025-12-18T13:30:00"), imagingLocation: "RAD-3", contrast: false, criticalResult: false },
  ...
  { id: "R025", patientId: "P124", patientName: "Sanjay Sharma", gdid: "124", ageSex: "20 | M", visitId: "V25-424", location: "Ward-A", bed: "Bed 5", tests: "Chest X-ray", type: "Radiology", modality: "X-ray", status: "Finalized", scheduledAt: new Date("2025-12-18T14:00:00"), imagingLocation: "RAD-1", contrast: true, criticalResult: false },
];
