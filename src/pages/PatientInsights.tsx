  ...
  const visits: Visit[] = [
    {
      ...
      items: [
        ...
        {
          type: "Consultation",
          datetime: "05 Aug 2025 | 06:00 PM",
          doctor: "Dr. Arun Kumar – Neurology",
          visitId: "VST-102345",
          ...
          prescriptions: [
            ...
            "Vitamin B12 supplement OD",
          ],
          findings: "Follow-up consultation for nerve pain management. Patient reports improvement with current medications. Continue current regimen and reassess in 2 weeks.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          findings: "Additional tests for metabolic screening. Lipid levels within normal range. HbA1c indicates good glycemic control.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          findings: "CT scan of head shows no acute intracranial pathology. Normal grey-white matter differentiation. No mass effect or midline shift.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          provider: "Inpatient Wing A",
          department: "Internal Medicine",
          findings: "Afternoon rounds. Patient showing improvement with hydration. Able to tolerate oral fluids. Continue IV fluids at reduced rate. Plan for discharge tomorrow if condition continues to improve.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: "Day-Care Admission",
          datetime: "07 Aug 2025 | 12:00 PM",
          doctor: "Dr. Sneha Iyer – Oncology",
          visitId: "VST-308972",
          procedure: "Post-Chemotherapy Observation",
          provider: "Day-Care Unit B",
          department: "Oncology",
          findings: "Post-infusion monitoring completed. Patient vitals remain stable. No signs of immediate adverse reactions. Patient discharged with home care instructions and emergency contact information.",
        },
      ],
    },
  ];
