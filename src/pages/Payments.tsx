...
import { InvoiceSummaryStructured } from "@/components/InvoiceSummaryStructured";
              ...
              <div className="grid grid-cols-[1fr_400px] gap-6">
                ...
                <div className="space-y-6">
                  <Card className="p-6 max-h-[calc(100vh-300px)] overflow-y-auto">
                    <h3 className="text-lg font-semibold text-primary mb-6">Invoice Summary</h3>
                    
                    <InvoiceSummaryStructured
                      patientName="Siva Karthikeyan"
                      patientId="GDID - 009"
                      age={35}
                      gender="M"
                      invoiceNo="IN-2025-009"
                      date="05/11/2025"
                    />
                  </Card>
                </div>
