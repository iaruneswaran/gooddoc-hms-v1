...
const BookAppointmentFromInsights = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 ml-[196px]">
        <AppHeader breadcrumbs={["GoodDoc", "Patient Insights", "Appointments"]} />
        ...
        <main className="p-8">
          ...
          >
            ...
            <span className="text-lg font-semibold">Patient Insights</span>
          </button>
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-start">
              ...
              <div className="w-full flex-1">
                {selectedType === "consultation" && consultationData ? (
                  ...
                  />
                ) : selectedType === "laboratory" && laboratoryData ? (
                ...
                <div className="space-y-6">
                  ...
                  {consultationData ? (
                    ...
                    <div className="pt-6 border-t border-border space-y-4">
                      ...
                      <div className="space-y-3 text-xs">
                        <div>
                          <p className="text-muted-foreground">When</p>
                          <p className="text-foreground font-medium">
                            {format(radiologyData.date, "dd/MM/yyyy")} {radiologyData.time} AM
                          </p>
                        </div>
                    ...
                    <div className="pt-6 border-t border-border space-y-4">
                      ...
                      <div className="space-y-3 text-xs">
                        ...
                        <div>
                          ...
                          <p className="text-foreground font-medium">{ipdAdmissionData.ward} - {ipdAdmissionData.bed}</p>
                        </div>

                        <div className="flex justify-between items-center pt-3 border-t border-border">
                          <p className="text-foreground">IPD Admission</p>
                    ...
                    <div className="pt-6 border-t border-border space-y-4">
                      <div className="flex items-start justify-between">
                        <div>
                          <p className="text-sm font-medium text-foreground mb-1">DC Procedure</p>
                          <button
                      ...
                      <div className="space-y-3 text-xs">
                        ...
                        <div className="flex justify-between items-center pt-3 border-t border-border">
                          <p className="text-foreground">{dcProcedureData.procedure}</p>
...
export default BookAppointmentFromInsights;
