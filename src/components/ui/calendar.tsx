  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-[43px] font-normal text-[0.8rem]",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-[43px] w-[43px] p-0 font-normal aria-selected:opacity-100"),
