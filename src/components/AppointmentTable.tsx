...
export function AppointmentTable({ 
  ...
  return (
    <div className="bg-card rounded-lg border border-border overflow-hidden w-full">
      {/* Table Header */}
      <div className="grid grid-cols-7 gap-4 px-4 py-4 border-b border-border bg-muted/30">
      ...
      {appointments.length === 0 ? (
        ...
        appointments.map((appointment) => (
          <div key={appointment.id} className="border-b border-border last:border-b-0">
            {/* Main Row */}
            <div className="grid grid-cols-7 gap-4 px-4 py-4 items-center hover:bg-muted/20 transition-colors">
              {/* Patient Info */}
