          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-muted/30">
                <tr>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">CLAIM NO.</th>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">TYPE</th>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">SUBMITTED</th>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">SERVICE / ICD</th>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">DIAGNOSIS</th>
                  <th className="text-right text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">BILLED</th>
                  <th className="text-right text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">APPROVED</th>
                  <th className="text-right text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">PAID</th>
                  <th className="text-right text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">PATIENT DUE</th>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">STATUS</th>
                  <th className="text-left text-xs font-normal text-muted-foreground p-3 whitespace-nowrap uppercase">ACTIONS</th>
                </tr>
              </thead>
