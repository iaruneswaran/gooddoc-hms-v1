...
export const SAMPLE_DOCTOR_CLEARANCE: DoctorClearance = {
  ...
  medicationReconciliation: {
    items: [
      { medId: "med-001", name: "Aspirin", action: "Continue", dose: "1 tablet", route: "PO", frequency: "Morning", duration: "Lifelong", instructions: "Take after breakfast", strength: "75mg" },
      { medId: "med-002", name: "Atorvastatin", action: "Continue", dose: "1 tablet", route: "PO", frequency: "Night", duration: "Lifelong", instructions: "Take at bedtime", strength: "40mg" },
      { medId: "med-003", name: "Metoprolol Succinate", action: "Continue", dose: "1 tablet", route: "PO", frequency: "Morning & Night", duration: "3 months", instructions: "Do not stop suddenly", strength: "50mg" },
      { medId: "med-004", name: "Clopidogrel", action: "Start", dose: "1 tablet", route: "PO", frequency: "Morning", duration: "1 year", instructions: "Take with food", reason: "Post-catheterization antiplatelet", strength: "75mg" },
      { medId: "med-005", name: "Ramipril", action: "Start", dose: "1 tablet", route: "PO", frequency: "Morning", duration: "Lifelong", instructions: "Monitor blood pressure", strength: "5mg" },
      { medId: "med-006", name: "Pantoprazole", action: "Start", dose: "1 tablet", route: "PO", frequency: "Before Breakfast", duration: "1 month", instructions: "Take 30 min before food", reason: "GI protection", strength: "40mg" },
      { medId: "med-007", name: "Metformin", action: "Continue", dose: "1 tablet", route: "PO", frequency: "Morning & Night", duration: "Lifelong", instructions: "Take with meals", strength: "500mg" },
      { medId: "med-008", name: "Rosuvastatin", action: "Continue", dose: "1 tablet", route: "PO", frequency: "Night", duration: "Lifelong", instructions: "Take at bedtime", strength: "10mg" },
    ],
    completed: true,
  },
  ordersInstructions: {
